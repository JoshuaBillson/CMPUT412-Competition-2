...
#         }
        ...
        tag_dict = {
            "8":{"intersection":"A4","coords":(1.89,2.83),"orient":math.pi/2},
            "13":{"intersection":"B3","coords":(1.32,1.87),"orient":-math.pi/2},
            ...
            "59":{"intersection":"A2","coords":(0.575,2.88),"orient":math.pi/2},
            "63":{"intersection":"E3","coords":(0.41,0.51),"orient":math.pi/2},
            "67":{"intersection":"C1","coords":(0.73,1.275),"orient":-math.pi/2},
            "75":{"intersection":"B2","coords":(0.72,1.87),"orient":-math.pi/2},
            "76":{"intersection":"C1","coords":(0.095,0.755),"orient":math.pi},
            "77":{"intersection":"C5","coords":(2.55,1.655),"orient":math.pi},
            "78":{"intersection":"C3","coords":(1.265,1.65),"orient":math.pi/2},
            ...
            "190":{"intersection":"A3","coords":(1.44,2.46),"orient":-math.pi/2},
            "191":{"intersection":"C1","coords":(0.485,0.055),"orient":math.pi},
            ...
            "304":{"intersection":"B3","coords":(1.305,2.285),"orient":math.pi/2},
        }
        return tag_dict
